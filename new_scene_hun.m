...
'111'
    ...
    switch option
        ...
        case 'welcome'
            Screen('FillRect',w,black);
            DrawFormattedText(w, 'Üdv!', 'center', 'center',[255 255 255 255]);
        case 'task_eye'
            '112'
            Screen('FillRect',w,black);
            '113'
        ...
        case 'task_hand'
            ...
            str = [str  'Ne fordulj el a kepernyo elol es kerlek igyekezz\n\n'];
            str = [str  'csak a szöveges utasítás alatt pislogni.\n\n'];
            str = [str  'Szolj ha keszen allsz!'];
            DrawFormattedText(w, str, 'center', 'center',[255 255 255 255]);
%             clearvars  str
        case 'task_foot'
