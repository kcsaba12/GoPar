function new_scene(option, w, rect)
    ...
    global LANGUAGE;
    TEXT_LIST = {'welcome', 'thanks', 'task_eye', 'task_12', 'task_34', ...
        'task_mixed_1234', 'task_1_m_text', 'task_1_mi_text', ...
        'task_2_m_text', 'task_2_mi_text', 'task_3_m_text', ...
        'task_3_mi_text', 'task_4_m_text', 'task_4_mi_text', ...
        'open_eye', 'closed_eye'};
